...
class CaptchaComponent extends Component {
	...
	public function initialize(&$controller, $settings = array()) {		
		...
		$this->privateKey=Configure::read("PRIVATE_KEY_FROM_RECAPTCHA_DOT_NET");
		
		if (!empty($settings['public_key'])) {
			$controller->params['Recaptcha.public_key'] = $settings['public_key'];
		}
		$controller->params['Recaptcha.public_key'] = Configure::read("PUBLIC_KEY_FROM_RECAPTCHA_DOT_NET");
