<div class="admin_area" >
    ...
    <div class="row">
        ...
        <div class="column grid_10 ">
            <?= $this->form->input('sale', array("type"=>"text",'placeholder'=>"Название", 'data-placeholder'=>"Название", 'label'=>false, 'div'=>false)) ;?>
        </div>
    </div>
    <div class="row">
        <div class="column grid_2 title-left">
        ...
        <div class="column grid_10 ">
            <?= $this->form->input('is_share', array('placeholder'=>"Название", 'data-placeholder'=>"Название", 'label'=>false, 'div'=>false)) ;?>
        </div>
    </div>    
    <div class="row">
        <div class="column grid_2 title-left">
