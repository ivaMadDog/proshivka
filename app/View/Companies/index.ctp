<div id="container">
	<div id="content">
        ...
        <p>
            В данном разделе все клиенты нашего сайта могут ознакомиться с компаниями-партнерами и 
            их ценами на услуги ремонта принтеров, заправки картриджей и ценами на лазерные/струйные
            принтеры Samsung, Xerox, Canon, HP. По всем вопросам о размещении рекламы своей компании
             пишите на почту info@proshivki.biz
        </p>
		<?if(!empty($data)) {?>
