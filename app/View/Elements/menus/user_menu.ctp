<ul class="user-page-nav">
    ...
    <li><a href="/user/users/orders"><span class="sprite-icons trademark"></span><span>Мои заказы</span></a></li>
    <li><a href="/user/users/change_password"><span class="sprite-icons psw"></span><span>Сменить пароль</span></a></li>
